...
def get_channel_videos(
    channel_identifier, api_key, output_filename="youtube_videos.csv"
):
    """
        ...
        if channel_identifier.startswith("UC"):
            ...
            try:
                request = youtube.channels().list(
                    part="contentDetails,snippet", forUsername=channel_identifier
                )
            ...
            except (HttpError, ValueError, KeyError):  # nosec B110
                # Legacy username lookup failed, continue to next method
                # This is expected behavior for channels that don't use legacy usernames
                pass
...
if __name__ == "__main__":
    ...
    if not API_KEY:
        ...
        print("Please set it with: export YOUTUBE_API_KEY='your_api_key_here'")  # nosec
        sys.exit(1)
